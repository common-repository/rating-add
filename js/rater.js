...
;(function ($, window){
    ...
    $.fn.rate.settings = {
        ...
        symbols: {
            ...
            fontawesome_trophy: '<i class="fa fa-trophy"></i>',
            fontawesome_tree: '<i class="fa fa-tree"></i>',
            fontawesome_star: {
            ...
            fontawesome_ban: {
                base: '<i class="fa fa-ban" aria-hidden="true"></i>',
                hover: '<i class="fa fa-ban" aria-hidden="true"></i>',
                selected: '<i class="fa fa-ban" aria-hidden="true"></i>',
            },
            fontawesome_thumbsup: {
                base: '<i class="fa fa-thumbs-up" aria-hidden="true"></i>',
                hover: '<i class="fa fa-thumbs-up" aria-hidden="true"></i>',
                selected: '<i class="fa fa-thumbs-up" aria-hidden="true"></i>',
            },
            utf8_emoticons: {
